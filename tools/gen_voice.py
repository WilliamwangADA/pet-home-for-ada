...
LINES = {
    ...
    "bark":       ("汪汪！", "+25%", "+60Hz"),
    "bark2":      ("汪呜～", "+15%", "+50Hz"),
    "park_out":   ("出发咯！我们去公园遛弯～", "+8%", "+12Hz"),
    "park_go":    ("哇，公园到啦！扔小球给它捡吧，还有蝴蝶可以追！", "+8%", "+12Hz"),
    "park_home":  ("到家啦～今天玩得真开心！", "+4%", "+10Hz"),
    "park_ball":  ("小球飞出去咯！", "+12%", "+15Hz"),
    "park_fetch": ("捡回来啦，好棒好棒！", "+10%", "+15Hz"),
    "park_friend":("哇，交到新朋友啦！", "+10%", "+15Hz"),
    "park_butterfly":("追到蝴蝶啦，好厉害！", "+10%", "+15Hz"),
    "dress_open": ("给它挑一件漂亮衣服吧！", "+6%", "+10Hz"),
    "dress_on":   ("哇，穿上真好看，转个圈圈！", "+8%", "+12Hz"),
    "adopt_open": ("这些小家伙都想有个家，挑一个吧！", "+6%", "+10Hz"),
    "adopt_new":  ("欢迎新伙伴回家！大家一起玩更热闹啦！", "+8%", "+12Hz"),
    "buddies":    ("看，它们玩到一起啦！", "+8%", "+12Hz"),
    "meow":       ("喵～", "+18%", "+55Hz"),
    "meow2":      ("喵呜～", "+10%", "+45Hz"),
}
